...
<%@ page import="com.kosta.jjh.dao.UserDao" %>
<%@ page import="com.kosta.jjh.dao.UserDaoImpl" %>
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					...
					<h2>안녕하세요.<br> 조정학의 mysite에 방문하신 것을<br/> 환영합니다.</h2>
					<p>
						...
						<br>
						<br>
						<a href="/mysite/gb">방명록</a>에 글 남기기 <!-- 메인화면에서 방명록 링크를 클릭시 guestbook으로 넘어간다. -->
						<br>
					</p>
				</div>
			</div>
